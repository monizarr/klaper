                    ...
                    <div class="card-body row">
                        <?php foreach ($sekolah as $a) : ?>
                            <div class="col-4 btn-group mb-3">
                                <a href="<?= site_url('/admin/sekolah/' . $a['id']) . '/angkatan' ?>" class="card card-primary py-3 fs-3 text-center text-decoration-none " style="border: 1px solid #066fd1a6; border-radius: 4px; box-sizing: border-box;">
                                    <h2>
                                        <?= $a['nama'] ?>
                                    </h2>
                                    <span>
